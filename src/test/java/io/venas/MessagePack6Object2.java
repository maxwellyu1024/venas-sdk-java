...
@Slf4j
public class MessagePack6Object2 {
...
//		MapValue mav = value2.asMapValue();
//		mav.p
...
//			ByteArrayInputStream in = new ByteArrayInputStream(bbb);
			MessagePack msgpack = new MessagePack();
//			Unpacker unpacker = msgpack.createUnpacker(in);
//			Template<Map<String, String>> mapTmpl = tMap(TString, TString);
//			Map<String, String> dstMap = unpacker.read(mapTmpl);
//			System.out.println(JSON.toJSONString(dstMap));
			Map<String, Object> dstMap = msgpack.read(bbb, Templates.tMap(Templates.TString, ObjectTemplate.getInstance()));
			System.out.println(JSON.toJSONString(dstMap));
